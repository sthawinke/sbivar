...
AnnData is python data format often used to store spatial experiment results, which can also be read into R. An AnnData object is e.g. created by reading an '.h5ad' with the functionality of the _anndata_ R-package. Here we take a file from [https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/GZFCWC](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/GZFCWC) from the publication by @Godfrey2025.

```{r readh5ad}
if(reqadzk <- (require(anndata) && require(zellkonverter))){
    download.file(url ="https://dataverse.harvard.edu/api/access/datafile/10714505?format=original", destfile = "LC_170.h5ad") #Download the h5ad file from the repository
    annDataObj = read_h5ad("LC_170.h5ad") #Read it in
    file.remove("LC_170.h5ad") #Remove the file
}
```
