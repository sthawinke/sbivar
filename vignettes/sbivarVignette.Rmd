...
gamRes = sbivarSingle(singleStx, singleMet, singleStxCoords, singleMetCoords, method = "GAMs",  families = FamiliesViari)
```
...
```{r}
plotGAMsTopResults(gamRes, singleStx, singleMet, singleStxCoords, singleMetCoords, families = FamiliesViari)
```
