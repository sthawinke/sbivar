...
multiMoranResSE = sbivar(X = StxSElist, Y = MetSElist, assayX = "transcripts", assayY = "metabolites",
                         method = "Moran", wo = "distance")
...
```{r SEidentifier}
SEsingleStx = SpatialExperiment(assays = list("transcripts" = t(Reduce(Vicari$TranscriptOutcomes, f = rbind))), 
...
SEsingleMet = SpatialExperiment(assays = list("metabolites" = t(Reduce(Vicari$MetaboliteOutcomes, f = rbind))), 
...
head(multiMoranLmmsResSingleSE$result$Intercept)
```
