...
plotTopPair(moransIRes, X = singleStx, Y = singleMet, Cx = singleStxCoords, 
            Ey = singleMetCoords, normalizationX = "log", normalizationY = "log")
```
...
For GAMs, we can also plot the corresponding spline fit, with the contributions to the correlation `r round(gamRes$result[gpGam<- rownames(gamRes$result)[1], "corxy"], 3)`:
