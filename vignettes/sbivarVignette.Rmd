...
Another feature is found most significant by GAMs, again with a negative relationship. For GAMs, we can also plot the corresponding spline fit, with the contributions to the correlation `r round(gamRes$result[gpGam<- rownames(gamRes$result)[1], "corxy"], 3)`:
...
if (reqadzk) {
    ...
    plotTopPair(GodfreyRes, speStx, speMet, size = 0.4)
}
```
