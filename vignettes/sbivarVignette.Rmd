...
We run a similar analysis based on Pearson correlation, now providing the experiment names on top of the assay names (since a _MultiAssayExperiment_ can contain more than two modalities):

```{r analyseMAE}
resMAE = sbivar(MAE, assayX = "transcripts", assayY = "metabolites", 
                experimentsX = "transcripts", experimentY = "metabolites", 
                families = FamiliesViari, method = "Correlation")
```
